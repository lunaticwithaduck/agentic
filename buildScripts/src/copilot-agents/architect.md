...
3. Map how the new feature touches existing modules by tracing imports, callers, and data flows
...
4. Present findings as a structured comparison with explicit trade-offs
...
- **Skills** - `mermaid-diagram` (for architecture diagrams)

...
2. Explore relevant existing code using Read, Glob, and Grep
3. Plan the changes (list files to modify/create)
4. Implement incrementally:
   - Make one logical change at a time
   - Write tests alongside the implementation
   - Run tests after each change
5. Self-review: check correctness, error handling, and style consistency

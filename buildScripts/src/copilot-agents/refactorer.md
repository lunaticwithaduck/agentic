...
4. Identify code smells systematically: duplication, long functions, deep nesting,
   unclear naming, excessive coupling, dead code
5. Map everything the target code touches using Grep and Read

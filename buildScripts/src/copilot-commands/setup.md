...
The hook to update is `.github/hooks/post-write.cjs`

### Step 4: Apply Changes
After gathering all information, apply changes to the platform-appropriate files:

1. Update `.github/copilot-instructions.md` — fill in Language/Framework, Build/Test/Lint commands, Key Directories
2. Update `.github/hooks/post-write.cjs` with language-specific linting (if user said yes in Step 3)
3. Confirm all changes made

### Step 5: Verify
- Confirm `.github/hooks/` scripts are present and executable
- Confirm `workflows/` directories exist (ideas, tasks, done, problems)

...
6. Use the relevant skill: `readme-generator`, `api-docs`, `onboarding-guide`,
   `technical-writing`, `changelog`, `code-walkthrough`
...
- **Skills** - `readme-generator`, `api-docs`, `onboarding-guide`, `technical-writing`,
  `changelog`, `code-walkthrough`, `summarize`, `explain-code`, `find-related`,
  `mermaid-diagram`, `weekly-summary`
